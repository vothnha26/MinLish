...
// Data models
data class RecentWordItem(val word: String, val meaning: String)
...
fun HomeScreen(
    ...
    val todayPlanDone = 6
    val todayPlanTotal = 20
    val progressPct = todayPlanDone.toFloat() / todayPlanTotal.toFloat()
    
    val recentWords = listOf(
        RecentWordItem("Ephemeral", "Lasting for a very short time"),
        RecentWordItem("Pragmatic", "Dealing with things sensibly"),
        RecentWordItem("Lucid", "Expressed clearly; easy to understand")
    )
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "${todayPlanTotal - todayPlanDone} words remaining",
                color = Color(0xFF6B6B6B),
                fontSize = 12.sp
            )
        }
